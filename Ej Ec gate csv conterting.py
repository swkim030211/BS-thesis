...
output_file_name = 'consolidated_data_by_column_Ej_Ec_error_num_t1_t2_gatetime_chargedispersion.csv'
# ------------------------------------------------------------------
...
def process_and_combine_csvs(input_dir, output_file):
    ...
    # 새로운 열의 제목(헤더)
    column_map = {0: 'Ec', 1: 'Ej', 2: 'Gate Error', 3: 'Gate Number', 4: 'T1',5: 'Tphi',6: 'Gate time ns',7: 'charge dispersion'}
    ...
    for file_path in csv_files:
        try:
            ...
            # 첫 3개의 열만 선택합니다.
            temp_df = df.iloc[:, [4, 3, 12, 15, 8, 9, 11, 10]]
